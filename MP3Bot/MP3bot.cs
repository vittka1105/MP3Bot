    ...
    class MP3bot
    {
        ...
        private async Task HandlerCallbackQuery(ITelegramBotClient botClient, CallbackQuery? callbackQuery)
        {
            ...
            if (callbackQuery.Message.ReplyToMessage != null && callbackQuery.Message.ReplyToMessage.Text.Contains("Enter a song title:"))
            {
                try
                {
                    ...
                    var json = webClient.DownloadString($"https://localhost:44379/Music/{name}");
            ...
            if (callbackQuery.Message.ReplyToMessage != null && callbackQuery.Message.ReplyToMessage.Text.Contains("Enter a term"))
            {
                try
                {
                    ...
                    var json = webClient.DownloadString($"https://localhost:44379/Music/AutoComplete?term={term}");
            ...
            if (callbackQuery.Data.StartsWith("Top list"))
            {
                ...
                var json = webClient.DownloadString($"https://localhost:44379/Music/TopList");
            ...
            if (callbackQuery.Data.StartsWith("Details"))
            {
                ...
                var json = webClient.DownloadString($"https://localhost:44379/Music/Details");
            ...
            if (callbackQuery.Data.StartsWith("Count"))
            {
                ...
                var json = webClient.DownloadString($"https://localhost:44379/Music/Count");
            ...
            {
                var json = webClient.DownloadString($"https://localhost:44379/Music/Recommendations");
            ...
            {
                var json = webClient.DownloadString($"https://localhost:44379/Music/TracksList");
            ...
            {
                var json = webClient.DownloadString($"https://localhost:44379/Music/Tracks");
            ...
            {
                var json = webClient.DownloadString($"https://localhost:44379/Music/Podcasts");
            ...
            if (callbackQuery.Data.StartsWith("Game of thrones audio book"))
            {
                ...
                var json = webClient.DownloadString($"https://localhost:44379/Music/SpecificBook");
            ...
            if (callbackQuery.Data.StartsWith("All game of thrones audiobooks"))
            {
                ...
                var json = webClient.DownloadString($"https://localhost:44379/Music/AllBooks");
        ...
        private async Task HandlerMessageAsync(ITelegramBotClient botClient, Message message)
        {
            ...
            if (message.Text == "Playlists")
            {
                ...
                var json = webClient.DownloadString($"https://localhost:44379/Music/Playlists");
